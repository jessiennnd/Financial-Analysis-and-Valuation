...
## Methodology
- Financial statement and ratio analysis (profitability, liquidity, leverage, efficiency)
- 5-year pro-forma financial modelling and cash flow forecasting
- Equity valuation using DCF, APV, DDM, and comparable company multiples (P/E, EV/EBITDA)
- Scenario, sensitivity, and Monte Carlo analysis to assess valuation risk

## Key Outcome
- Derived an intrinsic share price of 73,287 VND, indicating ~25% upside from market price (June 2023)
- Issued a BUY recommendation based on valuation results and risk-return assessment
